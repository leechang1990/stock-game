...
HINT_DATA = {
    'A': {'2015': '박스권 형성 중이던 가격 바닥 탈출', '2016': '두 번째 반감기(7월)로 공급량 축소', '2017': 'ico열풍 및 암호화폐 열풍', '2018': '급락장(버블 붕괴) 및 투자 심리 위축', '2019': '미중 무역전쟁 속 디지털 안전자산 부각', '2020': '코로나19 + 기관투자 유입', '2021': '테슬라 결제 수락 ATH', '2022': 'FTX 파산, 금리인상 여파 나스닥급락 속 안전자산 부각', '2023': '블랙록 ETF 승인 기대', '2024': '현물 ETF 승인, 반감기(4월)'},
    'B': {'2015': '소규모 커뮤니티 밈으로 주목', '2016': '트레이더들 단기 트레이딩 수단', '2017': 'ICO 붐 열풍', '2018': '버블 꺼지며 대규모 하락장', '2019': '트윗 및 틱톡 유행으로 유동성 유입으로 반등', '2020': '일론 머스크 트윗', '2021': '머스크 SNL 출연 및 언급', '2022': '트위터 결제수단 기대', '2023': '트위터 리브랜딩(X) 언급', '2024': '투기수요 위축'},
    'C': {'2015': '상장 전', '2016': 'DAO 해킹사태로 하드포크', '2017': 'ICO 붐을 이끌며 및 smart contract로 주목', '2018': '버블버블', '2019': '디파이의 태동', '2020': '유니스왑의 성장', '2021': 'NFT붐 및 암호화폐시장의 성장', '2022': '체굴 방식 변경 작업증명 >> 지분증명', '2023': 'L2확장', '2024': 'ETF승인 기대'},
    'D': {'2015': '상장 전', '2016': '상장 전', '2017': '상장 전', '2018': '상장 전', '2019': '상장 전', '2020': '메인넷 론칭', '2021': 'NFT시장의 성장을 주도함.', '2022': 'FTX파산 연계', '2023': '저렴한 수수료로 주목', '2024': '고성능 L1 대안 강조'},
    'E': {'2015': '신규 모델 출시', '2016': 'os 성능개선', '2017': '기존 모델 양산화 문제 발생', '2018': 'SEC의 제제', '2019': '대량생산 체제 확보', '2020': 'S&P500 편입', '2021': '도지 결제수단 연계', '2022': '오너리스크 발생 ??:주식가격이 높다', '2023': '가격 인하 전략', '2024': 'ai, 로보택시 기대'},
    'F': {'2015': '전자기기 시장확대 시장 점유율 증가', '2016': '지속적인 시장 점유율 증가', '2017': 'GPU사용 채굴로 수해주 등급', '2018': '암호화폐 버블 및 미중 무역전쟁 여파', '2019': '데이터센터 수요 증가', '2020': '코로나 이후 pc 수요 증가', '2021': 'ARM 인수 추진', '2022': '미중 규제로 중국판매 제한', '2023': 'chat gpt 붐!!', '2024': 'ai 투자싸이클 지속'},
    'G': {'2015': '상품 성능 부진...', '2016': '신규 cpu출시', '2017': '경쟁사 대비 점유율 하락', '2018': '데이터센터 수요확장', '2019': '7nm 공정 및 산업 주도', '2020': '비디오게임기 수요 급증', '2021': '자일링스 인수발표', '2022': 'pc 수요둔화', '2023': 'ai gpu 출시기대', '2024': '데이터센터 및 ai수요 증가'},
    'H': {'2015': '미 연준 금리인상 여파', '2016': '브렉시트 쇼크로 안전자산 수요증가', '2017': '위험자산 랠리로 박스권형성', '2018': '미중 무역갈등 속 안전자산 수요증가', '2019': '경기둔화 우려', '2020': '코로나 19 충격', '2021': '백신보급으로 수요둔화', '2022': '우크라이나 전쟁 발발', '2023': '인플레이션 정점 으로 수요 둔화', '2024': '금리 인하로 사상최고가 경신'},
    'I': {'2015': '상장 전', '2016': '상장 전', '2017': '상장 전', '2018': '신규상장', '2019': 'R&D스타트업', '2020': '코로나 19 백신 후보 등극', '2021': '백신 대량 공급', '2022': '코로나 수요 둔화', '2023': 'RSV백신 개발', '2024': '차세대 mRNA 백신 확대 + 정부 수주 발표'},
    'J': {'2015': '매출 및 수익 증가', '2016': '신규 제품 유럽 승인', '2017': '코스닥 > 코스피 이전 상장', '2018': '램시마 SC 유럽 판매 승인', '2019': '바이오주 전반적 조정기', '2020': '코로나19 항체치료제 임상 착수', '2021': '렉키로나 유럽 승인', '2022': '수익성 둔화 우려', '2023': '합병 추진 발표', '2024': '합병 완료, 포트폴리오 강화 발표'},
    'K': {'2015': '반도체 수익 증가', '2016': '스마트폰 제품 발화 사건', '2017': '메모리 슈퍼사이클', '2018': '메모리 반도체 업황 둔화우려', '2019': '비메모리 투자발표', '2020': '코로나 이후 수요증가', '2021': '신고가 갱신', '2022': '글로벌 금리 인상', '2023': 'HBM 수요 증가로 회복세', '2024': 'AI 메모리 수혜 기대'},
    'L': {'2015': '스마트폰 보급으로 사용층 확대', '2016': '캐릭터 사업 확장!', '2017': '플렛폼 독점적 성장', '2018': '플랫폼 확장 페이', '2019': '플랫폭 확장 뱅크', '2020': '언택트 트렌드', '2021': '빅테크 규제 우려', '2022': '정부 플랫폼 규제 강화', '2023': '오너리스크', '2024': '수익화 개선 전략 발표'},
